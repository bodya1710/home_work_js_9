...
for (const item of usersList) {
   let wrpaDiv =  document.createElement('div');
   ...
   streetDiv.innerText = `${item.address.street}`;
   let suiteDiv = document.createElement('div');
   suiteDiv.innerText = `${item.address.suite}`;
   let cityDiv = document.createElement('div');
   cityDiv.innerText = `${item.address.city}`;
   let zipcodeDiv = document.createElement('div');
   zipcodeDiv.innerText = `${item.address.zipcode}`;
   let geoDiv = document.createElement('div');
   geoDiv.innerText = `${item.address.geo}`;
   ...
   companyNameDiv.innerText = `${item.company.name}`;
   let catchPhraseDiv = document.createElement('div');
   catchPhraseDiv.innerText = `${item.company.catchPhrase}`;
   let bsDiv = document.createElement('div');
   bsDiv.innerText = `${item.company.bs}`;
    document.body.appendChild(wrpaDiv);
    wrpaDiv.appendChild(idDiv);
    wrpaDiv.appendChild(nameDiv);
    wrpaDiv.appendChild(username);
    wrpaDiv.appendChild(emailDiv);
    wrpaDiv.appendChild(addressDiv);
    ...
    wrpaDiv.appendChild(phoneDiv);
    wrpaDiv.appendChild(websiteDiv);
    wrpaDiv.appendChild(companyDiv);
    companyDiv.appendChild(companyNameDiv);
    companyDiv.appendChild(catchPhraseDiv);
    companyDiv.appendChild(bsDiv);
}
