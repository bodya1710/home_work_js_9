...
//     wrapDuration.style.display = 'flex';
//     monthDurationDiv.innerText = `${item.monthDuration}`;
//     monthDurationDiv.classList.add('hour');
...
//         modulesLi.innerText = `${element}`;
//         console.log(element)
//         modulesUl.appendChild(modulesLi);
//     }
//     wrap.appendChild(titleDiv);
//     wrap.appendChild(wrapDuration);
//     wrapDuration.appendChild(monthDurationDiv);
//     wrapDuration.appendChild(hourDurationDiv);
//     wrap.appendChild(modulesDiv);
//     wrap.appendChild(modulesUl);
//
// }
